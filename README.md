...
### 🏠 Home Interface
![Home Interface](screenshots/01_home_interface.png)

### 🔥 Priority Tasks
![Priority Tasks](screenshots/02_priority_tasks.png)

### 📅 Due Date Feature
![Due Date](screenshots/03_due_date_feature.png)

### ⚠ Overdue Task Warning
![Overdue](screenshots/04_overdue_warning.png)

### ✅ Completed Task (Strike-through)
![Completed Task](screenshots/05_completed_task.png)

### 📂 Completed Task Filter
![Completed Filter](screenshots/06_filter_completed.png)

### 🎨 Theme / Dark Mode
![Theme Mode](screenshots/07_theme_mode.png)

### 📱 Mobile Responsive View
![Mobile View](screenshots/08_mobile_view.png)
